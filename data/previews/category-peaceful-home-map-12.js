export const preview = {
  ...
  "coreGoal": [
    ...
    "◇ Rất nhiều người không đau vì thiếu tình yêu thương mà đau vì cảm thấy không ai thật sự hiểu mình. Họ có thể được quan tâm, được chăm sóc, được lo lắng nhưng vẫn cảm thấy khoảng cách tồn tại vì những điều quan trọng nhất trong lòng mình chưa từng được nhìn thấy hoặc được đón nhận đúng cách.",
    "◇ Có những người muốn được lắng nghe nhưng liên tục bị ngắt lời. Có những người muốn được công nhận cảm xúc nhưng lại chỉ nhận được lời khuyên. Có những người muốn được thấu hiểu nhưng lại bị đánh giá, so sánh hoặc áp đặt. Theo thời gian, họ dần học cách im lặng và giữ mọi thứ bên trong.",
    "◇ Điều đặc biệt là cảm giác không được thấu hiểu không chỉ xuất hiện từ hành động của người khác. Nó còn liên quan đến cách mỗi người diễn đạt cảm xúc, cách họ bảo vệ bản thân, những tổn thương trong quá khứ và những nhu cầu cảm xúc chưa từng được gọi tên.",
    "◇ Nhiều người không thật sự muốn người khác giải quyết vấn đề cho mình. Điều họ cần trước tiên là được công nhận cảm xúc, được lắng nghe trọn vẹn và được cảm nhận rằng trải nghiệm của mình có ý nghĩa. Khi điều đó không xảy ra, họ dễ hình thành cảm giác rằng không ai hiểu mình dù mọi người vẫn đang cố gắng giúp đỡ.",
    "◇ Có những khoảng cách được tạo ra bởi khác biệt thế hệ. Có những khoảng cách được tạo ra bởi khác biệt về tính cách, trải nghiệm sống hoặc cách nhìn nhận vấn đề. Khi các thành viên cố gắng hiểu nhau bằng góc nhìn của mình thay vì bằng góc nhìn của đối phương, sự thấu hiểu thường bị suy giảm đáng kể.",
    "◇ Một người cảm thấy không được thấu hiểu lâu ngày có thể dần thu mình lại, giảm chia sẻ, giảm kỳ vọng vào sự đồng hành của gia đình và bắt đầu tự xử lý mọi cảm xúc một mình. Đây chính là giai đoạn khoảng cách cảm xúc bắt đầu hình thành dù mối quan hệ bên ngoài có thể vẫn đang được duy trì.",
    "◇ MAP giúp nhìn ra điều gì đang khiến một người cảm thấy mình không được hiểu trong gia đình. Điều gì đang tạo ra khoảng cách trong giao tiếp. Điều gì đang khiến những nỗ lực kết nối không đạt được kết quả như mong đợi. Điều gì đang làm gia tăng cảm giác cô đơn về mặt cảm xúc. Điều gì đang khiến các thành viên nhìn thấy hành vi nhưng chưa nhìn thấy nhu cầu phía sau hành vi đó.",
    "◇ Đồng thời MAP giúp xác định những nhu cầu cần được nhìn thấy, những tổn thương cần được chữa lành, những rào cản cần được tháo gỡ và những thay đổi cần được thực hiện để các thành viên có thể hiểu nhau sâu sắc hơn.",
    "◇ Khi sự thấu hiểu được xây dựng, các thành viên không nhất thiết phải đồng ý với nhau trong mọi vấn đề. Điều quan trọng hơn là họ cảm nhận được rằng cảm xúc, suy nghĩ và trải nghiệm của mình đang được tôn trọng. Chính cảm giác được tôn trọng đó tạo nên nền tảng cho sự an toàn cảm xúc và kết nối bền vững.",
    ...
    "◇ Khi nhìn thấy điều gì đang làm giảm sự thấu hiểu, các thành viên sẽ có cơ hội thay đổi cách giao tiếp, cách lắng nghe và cách đồng hành với nhau.",
    "◇ Khi cảm giác được nhìn thấy, được công nhận và được hiểu xuất hiện, sự tin tưởng, sự an toàn cảm xúc và sự gần gũi sẽ được phục hồi một cách tự nhiên.",
    "◇ Khi các thành viên học được cách lắng nghe cảm xúc phía sau lời nói và nhu cầu phía sau hành vi, nhiều hiểu lầm kéo dài sẽ dần được tháo gỡ từ gốc rễ.",
    "◇ Một gia đình chữa lành không phải là gia đình luôn đồng ý với nhau. Một gia đình chữa lành là gia đình biết cách hiểu nhau ngay cả khi có những khác biệt trong suy nghĩ, cảm xúc và trải nghiệm sống, đồng thời vẫn lựa chọn tôn trọng và đồng hành cùng nhau trên hành trình trưởng thành.",
    "━━━━━━━━━━━━━━━",
